...
User.create!(email: 'steve@example.com', first_name: 'Steve', last_name: 'Johnson', password:  "password", role: :default, github_token: ENV['Github_access_token'], status: 'active')
